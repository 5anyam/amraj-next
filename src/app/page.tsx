  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-orange-50 to-white dark:from-[#232144] dark:to-[#18172b] pb-24 overflow-x-hidden transition-colors">
      ...
      <section className="relative max-w-6xl mx-auto py-14 px-4">
        <div className="absolute inset-0 z-0 bg-gradient-to-br from-orange-100/10 via-blue-300/5 to-white dark:from-orange-800/10 dark:via-blue-900/5 dark:to-[#18172b] pointer-events-none" />
        <h2 className="text-4xl font-playfair font-bold text-orange-700 dark:text-orange-400 mb-6 text-center animate-fade-in">
