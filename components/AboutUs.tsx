...
import { Sparkles, Leaf, CheckCircle, ShieldCheck, ThumbsUp, FlaskConical, ArrowRight } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            <div className="bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full border border-white/30">
              <span className="text-sm font-semibold text-gray-700">🌿 100% Natural</span>
            </div>
            <div className="bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full border border-white/30">
              <span className="text-sm font-semibold text-gray-700">🔬 Clinically Tested</span>
            </div>
            <div className="bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full border border-white/30">
