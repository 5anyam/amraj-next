    ...
    <div className="bg-gray-50 py-10 px-4 sm:px-8 md:px-20 lg:px-40">
      <div className="max-w-5xl mx-auto bg-white p-8 shadow-xl rounded-2xl">
        ...
        <section className="space-y-6 text-base leading-7 text-gray-800">
          ...
          <h2 className="text-xl font-semibold text-teal-700 mt-6">Order Verification (Calls/SMS)</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-teal-700 mt-6">Amendments to Terms</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-teal-700 mt-6">Contact Us</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-teal-700 mt-6">DND Compliance</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-teal-700 mt-6">Customer Commitment</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-teal-700 mt-6">Jurisdiction & Governing Law</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-teal-700 mt-6">Legal Disclaimer</h2>
